...
def train(output_directory,
    ...
    training_data = np.split(training_data, training_data.shape[0]/8, 0) # batch size = 8, 為了創造 batch，除不盡可用 np.array_split
    # training_data = np.array_split(training_data, training_data[0]/64)
